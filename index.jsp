...
<body>
<%
    String gitlabURL = "https://gitlab.univ-lille.fr/oauth/authorize?client_id="+Config.get("gitlab.client_id")+"&redirect_uri="+ URLEncoder.encode(Config.get("redirect_uri"))+"%3Ffrom%3Dgitlab&scope=read_user&response_type=code";
